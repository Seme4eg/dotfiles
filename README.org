...
- *dependencies*:
 ...
 - *yay*: xdg-desktop-portal-hyprland-git wlsunset-git brillo hyprpaper-git
   webcord bemenu-git brillo hyprland-git eww-wayland-git
...
** Todos
- setup [[https://github.com/nyyManni/dmenu-wayland][dmenu-wl]] and see which [[https://tools.suckless.org/dmenu/scripts/][scripts]] and patches i might need + [[https://github.com/sentriz/cliphist][cliphist]]
  bindings ain't finished
...
- life updating cursor doesn't work, need to restart compositor
- write a script that cheks my current location every day and updates wlsunset
  ...
  was yesterday.
- take a look at [[https://www.chezmoi.io/#i-like-chezmoi-how-do-i-say-thanks][chezmoi]] dotfile manager, and one-line installer script from
  [[https://github.com/Battlesquid/dotfiles][this repo]]
