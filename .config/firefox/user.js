 ...
 * START: MY OVERRIDES                                                      *
****************************************************************************/
// Common overrides: https://github.com/yokoffing/Betterfox/issues/87
// Enter your personal prefs below this line:

// Firefox View & Sync
user_pref("browser.tabs.firefox-view", true); // PREF: restore Firefox View UI
user_pref("identity.fxaccounts.enabled", true); // PREF: restore Firefox accounts
user_pref("dom.push.enabled", true); // PREF: Push API seems to be needed for Sync
