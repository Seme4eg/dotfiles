...
** Todos
- GPG asks for key on every mu4e update
- restore pacman default hooks (especially openrc one (idk what was in there
  tho)) from another machine with freshly installed artix
- swaylock and sleep do not stop cooling system, setup hybernation???
- how to [[https://askubuntu.com/questions/37767/how-to-access-a-usb-flash-drive-from-the-terminal#37775][automount]] usbs?
